        ...
        <main className="p-10 print:p-8">
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 skill-card p-4 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
              ...
              {/* Frontend & Portais */}
              <div className="skill-card p-4 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
                <h3 className="font-bold text-slate-800 mb-3 flex items-center gap-2 text-base uppercase">
                  <span className="w-1.5 h-1.5 bg-slate-900 rounded-full"></span>
                  Frontend & Portais
                </h3>
              ...
              <div className="md:col-span-2 skill-card p-5 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              {/* Claro */}
              <div className="bg-slate-50 experience-card p-6 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
              ...
              {/* Adiante Group */}
              <div className="experience-card p-6 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
                <div className="flex flex-col md:flex-row md:justify-between md:items-baseline mb-4 border-b border-slate-200 pb-2">
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Hydra Data */}
                <div className="experience-card p-5 rounded-lg border border-slate-200 shadow-sm print:shadow-none h-full">
              ...
              <div className="experience-card p-5 rounded-lg border border-slate-200 shadow-sm print:shadow-none">
