...
| Skill | Description | Phases |
|-------|-------------|--------|
| [Resume Writer](./resume-writer/SKILL.md) | ajusta o texto da uma determinada vaga a criando corretamente a sk especialidade do usuario! | E, V |
